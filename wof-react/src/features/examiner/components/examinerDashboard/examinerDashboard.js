...
import UpdatedTheme from "../examinerDashboard/updatedTheme";
...
const handleLogout = (navigate) => {
    ...
    console.log('Token after removal:', localStorage.getItem('examinerToken')); // Check if the token is removed
